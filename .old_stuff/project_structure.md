...
<body>
  <header>
    <div class="logo">
      <img src="/map/assets/logo.png" alt="Fol e Ar" onclick="window.location.href='/map/index.html'">
      <h1>fol e ar</h1>
    </div>
    <nav>
      <a href="/map/index.html">Mapa</a>
      <a href="/map/about.html">Sobre Nós</a>
    </nav>
  </header>
  ...
  <script type="module" src="/map/js/concello.js"></script>
</body>
</html>
...
<body>
  ...
  <script type="module" src="/map/js/comarca.js"></script>
</body>
</html>
...
<head>
  ...
  <link rel="stylesheet" href="/map/css/style.css">
  <link rel="stylesheet" href="/map/css/markdown.css"> <!-- Estilos específicos para Markdown -->
  <script src="https://cdn.jsdelivr.net/npm/marked/marked.min.js"></script>
  <script type="module" src="/map/js/pieza.js"></script>
</head>
<body>
  <header>
    <div class="logo">
      <img src="/map/assets/logo.png" alt="Fol e Ar" onclick="window.location.href='index.html'">
      <h1>fol e ar</h1>
    </div>
  </header>
...
<body>
  ...
  <script type="module" src="/map/js/parroquia.js"></script>
</body>
</html>
...
<body>
  ...
  <script type="module" src="/map/js/provincia.js"></script>
</body>
</html>
...
### .git/ORIG_HEAD
```
b08d847e66b4958fe8026a654b73fb8a91cdd10b
